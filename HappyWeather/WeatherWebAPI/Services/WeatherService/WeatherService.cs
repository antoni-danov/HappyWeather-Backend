...
namespace WeatherWebAPI.Services.WeatherService
{
    public class WeatherService : IWeatherService
    {
        ...
        public async Task<HttpResponseMessage> GetRealTimeForecast(string city, string unit)
        {
          return  await this.client.GetAsync($"{Environment.GetEnvironmentVariable("TOMORROW_BASE_URL")}weather/realtime?location={city}&language=en-US&units={unit}&apikey={Environment.GetEnvironmentVariable("TOMORROW_API_KEY")}");
        }
